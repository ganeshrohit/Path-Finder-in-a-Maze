    ...
    while q1.size > 0:
        ...
        if (isClear(current.x+1, current.y)):
            ...
            if ((current.x+1, current.y) not in closed):
                ...
                if revG:
                    q1.put(
                        (cost, -1*gval[(current.x+1, current.y)], Step(current.x+1, current.y, current)))
                else:
                    q1.put((cost, gval[(current.x+1, current.y)],
                           Step(current.x+1, current.y, current)))
        ...
        if (isClear(current.x, current.y+1)):
            ...
            if ((current.x, current.y+1) not in closed):
                ...
                if revG:
                    q1.put(
                        (cost, -1*gval[(current.x, current.y+1)], Step(current.x, current.y+1, current)))
                else:
                    q1.put((cost, gval[(current.x, current.y+1)],
                           Step(current.x, current.y+1, current)))
